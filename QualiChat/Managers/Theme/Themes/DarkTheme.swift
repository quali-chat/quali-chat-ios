...
class DarkTheme: NSObject, Theme {
    ...
    var backgroundColor: UIColor = UIColor(rgb: 0x000000)

    var baseColor: UIColor {
        BuildSettings.newAppLayoutEnabled ? UIColor(rgb: 0x000000) : UIColor(rgb: 0x21262C)
    }
    ...
    var tintBackgroundColor: UIColor = UIColor(rgb: 0x000000)
    ...
    var noticeSecondaryColor: UIColor = UIColor(hexString: "#9BAFF7")
    ...
    ///  MARK: - Theme v2
    var colors: ColorsUIKit = CustomDarkColors.uiKit
    
    var fonts: FontsUIKit = FontsUIKit(customValues: CustomElementsFonts())
